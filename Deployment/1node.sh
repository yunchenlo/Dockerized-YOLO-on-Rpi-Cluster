...
helm install --name 1node \
			...
			--set operator.op0.device.hostname=yclo-pi-1,operator.op0.resource.cpu=750,operator.op0.resource.mem=380         \
			--set operator.op1.ip=192.168.1.205,operator.op1.port=8061,operator.op1.device.type=rpi,operator.op1.device.label=0         \
			--set operator.op1.device.hostname=yclo-pi-1,operator.op1.resource.cpu=1000,operator.op1.resource.mem=200         \
			--set operator.op2.ip=192.168.1.205,operator.op2.port=8062,operator.op2.device.type=rpi,operator.op2.device.label=0         \
			--set operator.op2.device.hostname=yclo-pi-1,operator.op2.resource.cpu=1000,operator.op2.resource.mem=200  helmChart/yolo/
