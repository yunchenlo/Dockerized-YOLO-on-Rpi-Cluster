...
helm install --name 2node \
			...
			--set operator.op1.device.hostname=yclo-pi-3,operator.op1.resource.cpu=250,operator.op1.resource.mem=252         \
			--set operator.op2.ip=192.168.1.167,operator.op2.port=8062,operator.op2.device.type=rpi,operator.op2.device.label=2         \
			--set operator.op2.device.hostname=yclo-pi-3,operator.op2.resource.cpu=250,operator.op2.resource.mem=214  helmChart/yolo/
