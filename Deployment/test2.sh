...
helm install --name test2 \
			...
			--set operator.op1.device.hostname=yclo-pi-2,operator.op1.resource.cpu=252,operator.op1.resource.mem=126         \
			--set operator.op2.ip=192.168.1.93,operator.op2.port=8062,operator.op2.device.type=rpi,operator.op2.device.label=1         \
			--set operator.op2.device.hostname=yclo-pi-2,operator.op2.resource.cpu=20,operator.op2.resource.mem=107  helmChart/yolo/